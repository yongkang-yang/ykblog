...
```bash
git clone https://github.com/yongkang-yang/ykblog.git
cd ykblog
...
This blog is automatically deployed using GitHub Actions. Every push to the `master` branch that changes content, themes, or configuration files will trigger a deployment to GitHub Pages.

The deployment workflow:
1. Checks out the repository with submodules
2. Sets up Hugo Extended
3. Builds the site with `hugo --minify`
4. Deploys to the external repository `yongkang-yang/yongkang-yang.github.io`

### Deployment Requirements

To enable automatic deployment, ensure you have:
- A `DEPLOY_KEY` secret configured in your repository settings
- The external repository `yongkang-yang/yongkang-yang.github.io` created and accessible
...
2. Run the convenience script:
   ...
   ./start-server.sh
   ```
3. Codespaces will automatically forward port 1313 and prompt you to open the site in your browser
